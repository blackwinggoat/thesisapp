...
@section('isi')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="the-box">
                <form method="get" action="{{ url('akademikprodi/mahasiswa') }}" class="form-horizontal" style="margin-bottom: 18px;">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <div>
                                ...
                                <a href="{{ url('akademikprodi/mahasiswa') }}" class="btn btn-default">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
