...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .receipt-table { font-size: 8.8pt; margin-top: 5px; table-layout: fixed; }
    ...
    @foreach ($reports as $report)
        <div class="document">
            ...
            <table class="identity">
                <tr><td class="label">Tanggal Ujian</td><td class="separator">:</td><td class="value">{{ helper::tgl_indo_lengkap($date) }}</td></tr>
            ...
            <table class="receipt-table">
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="4" class="total-label">TOTAL HONORARIUM</td>
                        <td class="total-amount">{{ helper::formatRupiah($report->total_honor) }}</td>
                    </tr>
                </tbody>
            </table>

            <p class="statement">Dengan ini saya menyatakan telah menerima honorarium pelaksanaan ujian sesuai rincian penugasan di atas dengan jumlah sebesar <strong>{{ helper::formatRupiah($report->total_honor) }}</strong>.</p>

            <table class="signature">
                <tr>
                    <td class="signature-note">Dokumen ini menjadi bukti penerimaan honorarium dosen pada tanggal ujian yang tercantum di atas.</td>
