...
@section('script')
    <script>
        // Initialize Bootstrap Toggle for all checkboxes
        $(function() {
            ...
            $('input[data-toggle="toggle"]').change(function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $(this).bootstrapToggle('toggle'); // Revert the toggle switch
                    }
                });
            });

            $('.view-honorarium-btn').click(function() {
                var ks = $(this).data('ks');
                var pu = $(this).data('pu');
                var pp = $(this).data('pp');
                var p1 = $(this).data('p1');
