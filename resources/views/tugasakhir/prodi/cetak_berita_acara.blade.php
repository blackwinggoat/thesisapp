...
<body>
    ...
    <div class="title">
        <u>
            <h1 class="headingTitle">TANDA TERIMA</h1>
        </u><br>
    </div>
    <br>
    <p align="justify">
        Dengan Rahmat Allah SWT. saya yang bertanda tangan dibawah ini telah menerima Skripsi mahasiswa untuk ujian
        {{ $tipe_ujian }} atas
    </p>
    <div>
        <table style="text-align: left">
            <tr>
                ...
                <td>{{ ucwords(strtolower(\App\Model\t_mst_mahasiswa::where('C_NPM', $nim)->first()->NAMA_MAHASISWA)) }}
                </td>
            </tr>
            <tr>
                <th>Stambuk</th>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ helper::judulDenganKodeJenisTugasAkhir($trt_bimbingan->jenis_tugas_akhir_id ?? null, $trt_bimbingan->judul) }}</td>
            </tr>
        </table>
    </div>
    <br>
    ...
    <div class="legalitor">
        Makassar,
        {{ Illuminate\Support\Carbon::parse(substr($trt_penguji->created_at, 0, 10))->formatLocalized('%d %B %Y') }}
        <br>
        Ketua Program Studi
    </div>
    <br>
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td style="vertical-align: top">:</td>
                <td style="vertical-align: top" colspan="2">{{ helper::judulDenganKodeJenisTugasAkhir($trt_bimbingan->jenis_tugas_akhir_id ?? null, $trt_bimbingan->judul) }}
                </td>
            </tr>
            <tr>
    ...
    @if ($trt_penguji->tipe_ujian != '0')
        ...
        <div>
            <table class="assessment-identity-table">
                ...
                <tr>
                    ...
                    <td style="padding-right: 10px">:</td>
                    <td colspan="2">
                        {{ strtoupper(\App\Model\t_mst_mahasiswa::where('C_NPM', $nim)->first()->NAMA_MAHASISWA) }}
                    </td>
                </tr>
                <tr>
        ...
        <div class="assessment-score-panel" style="position: relative">
            <table class="assessment-score-table" style=" margin: 0 auto" border="1" width="550px" cellpadding="4" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><b>Penguasaan Materi:</b><br> <b>2.1 Dasar Teori</b> (Konsep Teori Riset, dan materi yang
                        relevan)<br><br><b>2.2 Aplikasi yang dibuat mahasiswa</b> (Pengoperasian OS dan Running Program)
                    </td>
        ...
        <div class="header"
                ...
                <div style="display: flex; align-items: center; margin-right: 30px !important;">
                    <img src="{{ asset('umi.png') }}" alt="Logo Institusi"
                        style="width: 50px; height: auto; margin-right: 10px;" />
                    <img src="{{ asset('fikom-logo.png') }}" alt="Logo Institusi"
            ...
            <div class="assessment-score-panel" style="position: relative">
                <table class="assessment-score-table" style=" margin: 0 auto" border="1" width="550px" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        <td align="center">3</td>
                        <td><b>Penguasaan Materi:</b><br> <b>2.1 Dasar Teori</b> (Konsep Teori Riset, dan materi yang
                            relevan)<br><br><b>2.2 Aplikasi yang dibuat mahasiswa</b> (Pengoperasian OS dan Running
                            Program)</td>
                        <td align="center">40%</td>
                        <td align="center">0 - 20</td>
                        <td align="center">.......</td>
            ...
            <div style="position: relative">
                <table class="assessment-score-table" border="1" width="550px" cellpadding="4" cellspacing="0" style="margin: 0 auto">
                    <tr>
                        <th>No.</th>
                        <th colspan="2">Nama Tim Penguji</th>
                    ...
                    <tr>
                        <td>4</td>
                        <td>Penguji 1</td>
                        <td>{{ helper::getNamaDosenByKode($trt_penguji->penguji_I_id) }}
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>Penguji 2</td>
                        <td>{{ helper::getNamaDosenByKode($trt_penguji->penguji_II_id) }}
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
            ...
            <div style="position: relative">
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: left; white-space: nowrap"><b>NIP/NIDN:
                                {{ $trt_penguji->ketua_sidang_id }}</b></td>
                    </tr>
                </table>
            </div>
            <br><br>
