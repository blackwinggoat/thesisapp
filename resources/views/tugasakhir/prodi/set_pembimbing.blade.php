                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            ...
                            <input type="hidden" name="topik_id" value="{{$data_topik->topik_id}}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="form-control bold-border">{!! helper::jenisTugasAkhirBadge($data_topik->jenis_tugas_akhir_id ?? null) !!}</div>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group">
