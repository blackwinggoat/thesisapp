...
<body>
    ...
    <div>
        <table>
            <tr>
                ...
                <td>:</td>
                <td><b>{{ helper::judulDenganKodeJenisTugasAkhir($bimbingan->jenis_tugas_akhir_id ?? null, $bimbingan->judul) }}</b></td>
            </tr>
        </table>
    </div>
    <br>
    ...
    <div class="legalitor">
        Makassar,
        {{ Illuminate\Support\Carbon::parse(substr($penguji->created_at, 0, 10))->formatLocalized('%d %B %Y') }}
        <br>
        Ketua Program Studi
    </div>
    <br>
