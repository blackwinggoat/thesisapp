...
<body>
    @php
        $namaProdi = helper::getProgramStudiByNim($datax[0]->C_NPM ?? '') ?: helper::getProgramStudiByAuthUser(Auth::user()->name);
    ...
    <div class="legalitor">
        Makassar,
        {{ Illuminate\Support\Carbon::parse(substr($datax[0]->created_at, 0, 10))->formatLocalized('%d %B %Y') }}
    </div>
    <br>
    ...
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br <h4>Lampiran Surat Penunjukan No
    {{ $nomor }}</h4>
