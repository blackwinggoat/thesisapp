...
class HonorariumAutomaticTypeSetupTest extends TestCase
{
    public function testAutomaticTypeSetupUsesExamProposalDecreeClassAndFinalProjectTypeWithoutAi()
    {
        ...
        $this->assertStringContainsString('Terapkan Otomatis', $view);
        $this->assertStringContainsString('Reset', $view);
        ...
        $this->assertStringContainsString('Setup Otomatis', $view);
        $this->assertStringContainsString('data-toggle="collapse" data-target="#automatic-setup-help"', $view);
        $this->assertStringContainsString('Setup berhenti bila ada data bermasalah', $view);
        $this->assertStringContainsString('Ujian Akhir + SK Proposal', $view);
        ...
        $this->assertStringContainsString('risiko Proposal ganda', $view);
        $this->assertStringContainsString('automatic-setup-status', $view);
        $this->assertStringContainsString('Cari NIM atau nama', $view);
        $this->assertStringContainsString('Singkatan peran', $view);
