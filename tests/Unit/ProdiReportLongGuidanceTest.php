...
{
    public function testReportListsUngradatedStudentsBeyondTwoYearsAfterFirstSkRegardlessOfLegacyMasterStatus()
    {
        ...
        $this->assertStringNotContainsString("m.C_KODE_STATUS_AKTIF_MHS = 'A'", $controller);
