...
class trt_bimbingan extends Model
{
  ...
  protected $fillable = ['bimbingan_id', 'C_NPM', 'pembimbing_I_id', 'pembimbing_II_id', 'judul', 'jenis_tugas_akhir_id', 'status_I', 'status_II', 'status_bimbingan', 'status_sk', 'user_id'];
